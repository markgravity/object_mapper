...
class Mapper {
	...
	_fromJson<T>(String field, dynamic value, MappingSetter setter, [Transformable transform]) {
	...
	_toJson<T>(String field, dynamic value, MappingSetter setter, [Transformable transform]) {
