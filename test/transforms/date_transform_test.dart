...
void main() {
	...
	group("toJson", () {
		test("#1 Input is string", () {
			...
			expect(transform.toJson(date), DateTime(2019, 2, 2, 2, 12, 33).millisecondsSinceEpoch / 1000);

			// non-full date string
			date = DateTime(2019, 2, 2, 2, 0, 12);
			expect(transform.toJson(date), DateTime(2019, 2, 2, 2, 0, 12).millisecondsSinceEpoch / 1000);

			// haft date string
			date = DateTime(2019, 2, 2);
			expect(transform.toJson(date), DateTime(2019, 2, 2).millisecondsSinceEpoch / 1000);
		});
